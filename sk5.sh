...
#   Dscription: Socks5 Install Script
#   Version: 1.0
#====================================================
...
# Xray Installation
wget -O /usr/local/bin/socks --no-check-certificate https://github.com/siemenstutorials/MutiPxray/releases/download/v20221022/socks
